...
/**
 * The Class LoadModelLinear.
 *
 * @author		Anton Beloglazov
 * @since		CloudSim Toolkit 2.0
 */
public class TrafficModelLinear implements TrafficModel {
	 ...
	 */
	public TrafficModelLinear(double maxLoad, double staticLoadPercent) {
		setMaxLoad(maxLoad);
		setStaticLoad(staticLoadPercent * maxLoad);
		setConstant((maxLoad - getStaticLoad()) / 100);
	}
	...
	public double getLoad(double utilization) throws IllegalArgumentException {
		...
		return getStaticLoad() + getConstant() * utilization * 100;
	}
