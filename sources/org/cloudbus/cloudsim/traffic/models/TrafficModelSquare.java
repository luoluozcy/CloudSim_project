...
/**
 * The Class LoadModelSquare.
 *
 * @author		Anton Beloglazov
 * @since		CloudSim Toolkit 2.0
 */
public class TrafficModelSquare implements TrafficModel {
	 ...
	 */
	public TrafficModelSquare(double maxLoad, double staticLoadPercent) {
		setMaxLoad(maxLoad);
		setStaticLoad(staticLoadPercent * maxLoad);
		setConstant((maxLoad - getStaticLoad()) / Math.pow(100, 2));
	}

	/* (non-Javadoc)
	 * @see gridsim.virtualization.power.LoadModel#getLoad(double)
	 */
	@Override
	...
	//public double getLoad(double utilization) throws IllegalArgumentException {
		...
		return getStaticLoad() + getConstant() * Math.pow(utilization * 100, 2);
	}
