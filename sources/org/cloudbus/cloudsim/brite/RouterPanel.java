...
public final class RouterPanel extends JPanel  implements ActionListener {
	...
	double bwMin = getNumFromTextField(rtBWMin, 1);
	double bwMax = getNumFromTextField(rtBWMax, 1024);
	...
	RouterFileBeingReadLabel.setFont(new Font("SansSerif", Font.PLAIN, 12));
    ...
    String RT_BARABASI = "Barabasi";
    
    String[] modelTypeData = {RT_WAXMAN, RT_BARABASI};
